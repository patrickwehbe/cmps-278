...
function Application() {
  ...
  const newReleasesApps = getRandomUniqueApps(currentData, recommendedApps, maxRecommendedApps);
  const topSellingApps = getRandomUniqueApps(currentData, [...recommendedApps, ...newReleasesApps], maxRecommendedApps);
